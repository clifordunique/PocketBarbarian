...
public abstract class AbstractPlatformController2D: RaycastController2D, ITriggerReactor {
    ...
    [HideInInspector]
    public Dictionary<Transform, IMove> passengerDictionary = new Dictionary<Transform, IMove>();
    ...
    public virtual void ReactToPassenger(Vector3 velocity, PassengerMovement passenger) {
        // can be overriden from other classes to reacht to passenger move
    }
